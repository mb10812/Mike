...
dns_records = {
    ...
    # ------------------------------------------------------------------
    # Additional A records from assignment spec
    'google.com.': {
    ...
    'nyu.edu.': {
        ...
        # Exact AAAA from assignment spec
        dns.rdatatype.AAAA: '2001:0db8:85a3:0000:0000:8a2e:0373:7312',
        # Exact MX from assignment spec
        dns.rdatatype.MX:   [(10, 'mxa-00256a01.gslb.pphosted.com.')],
        # Exact NS from assignment spec
        dns.rdatatype.NS:   'ns1.nyu.edu.',
        # TXT: str() cast of the encrypted token — exactly as spec says:
        # "a string cast version of your encrypted secret data from step 3"
    ...
    while True:
        try:
            ...
            if qname in dns_records and qtype in dns_records[qname]:
                ...
                # One RRset per (name, class, type) with TTL set before appending.
